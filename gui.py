...
class PyPaperBotGUI(ctk.CTk):
    ...
    def _build_header(self):
        header = ctk.CTkFrame(self, corner_radius=18, fg_color=("#e8eefc", "#13233d"))
    ...
    def _build_search_tabs(self):
        self.tabs = ctk.CTkTabview(self, height=240)
        self.tabs.grid(row=1, column=0, padx=20, pady=10, sticky="ew")
    ...
    def _build_settings(self):
        ...
        settings.grid(row=2, column=0, padx=20, pady=10, sticky="ew")

        for column in (1, 3, 5):
            settings.grid_columnconfigure(column, weight=1)

        ctk.CTkLabel(settings, text="Download Dir").grid(row=0, column=0, padx=12, pady=12, sticky="e")
        self.dir_entry = ctk.CTkEntry(settings, placeholder_text="Directory for PDFs, CSV, and BibTeX")
        self.dir_entry.grid(row=0, column=1, columnspan=4, padx=(0, 8), pady=12, sticky="ew")
        self.dir_button = ctk.CTkButton(settings, text="Browse", width=110, command=self.select_directory)
        self.dir_button.grid(row=0, column=5, padx=(8, 12), pady=12, sticky="e")

        ctk.CTkLabel(settings, text="Min Year").grid(row=1, column=0, padx=12, pady=10, sticky="e")
        self.min_year_entry = ctk.CTkEntry(settings, placeholder_text="2018")
        self.min_year_entry.grid(row=1, column=1, padx=(0, 12), pady=10, sticky="ew")

        ctk.CTkLabel(settings, text="Max by Year").grid(row=1, column=2, padx=12, pady=10, sticky="e")
        self.max_year_entry = ctk.CTkEntry(settings, placeholder_text="Optional")
        self.max_year_entry.grid(row=1, column=3, padx=(0, 12), pady=10, sticky="ew")

        ctk.CTkLabel(settings, text="Max by Cites").grid(row=1, column=4, padx=12, pady=10, sticky="e")
        self.max_cites_entry = ctk.CTkEntry(settings, placeholder_text="Optional")
        self.max_cites_entry.grid(row=1, column=5, padx=(0, 12), pady=10, sticky="ew")

        ctk.CTkLabel(settings, text="Sci-Hub Mirror").grid(row=2, column=0, padx=12, pady=10, sticky="e")
        self.scihub_entry = ctk.CTkEntry(settings, placeholder_text="https://sci-hub.se")
        self.scihub_entry.grid(row=2, column=1, padx=(0, 12), pady=10, sticky="ew")

        ctk.CTkLabel(settings, text="Annas Mirror").grid(row=2, column=2, padx=12, pady=10, sticky="e")
        self.annas_entry = ctk.CTkEntry(settings, placeholder_text="https://annas-archive.se")
        self.annas_entry.grid(row=2, column=3, columnspan=3, padx=(0, 12), pady=10, sticky="ew")

        ctk.CTkLabel(settings, text="Single Proxy").grid(row=3, column=0, padx=12, pady=10, sticky="e")
        self.single_proxy_entry = ctk.CTkEntry(
            settings,
            placeholder_text="http://127.0.0.1:8080",
        )
        self.single_proxy_entry.grid(row=3, column=1, padx=(0, 12), pady=10, sticky="ew")

        ctk.CTkLabel(settings, text="Restrict").grid(row=3, column=2, padx=12, pady=10, sticky="e")
        self.restrict_menu = ctk.CTkOptionMenu(
            settings,
            variable=self.restrict_value,
            values=["Download PDFs + BibTeX", "BibTeX only", "PDF only"],
        )
        self.restrict_menu.grid(row=3, column=3, padx=(0, 12), pady=10, sticky="ew")
        ...
        self.use_doi_checkbox.grid(row=3, column=4, columnspan=2, padx=12, pady=10, sticky="w")

        ctk.CTkLabel(settings, text="Proxy Chain").grid(row=4, column=0, padx=12, pady=(10, 12), sticky="ne")
        self.proxy_textbox = ctk.CTkTextbox(settings, height=72)
        self.proxy_textbox.grid(row=4, column=1, columnspan=5, padx=(0, 12), pady=(10, 4), sticky="ew")
        ...
        proxy_hint.grid(row=5, column=1, columnspan=5, padx=(0, 12), pady=(0, 14), sticky="w")

    def _build_actions(self):
        actions = ctk.CTkFrame(self, fg_color="transparent")
        actions.grid(row=3, column=0, padx=20, pady=10, sticky="ew")
    ...
    def _build_console(self):
        ...
        self.console.grid(row=4, column=0, padx=20, pady=(10, 20), sticky="nsew")
